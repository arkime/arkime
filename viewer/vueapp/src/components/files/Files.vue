  ...
  data: function () {
    return {
      ...
      columns: [ // node stats table columns
        ...
        { id: '@timestamp', name: 'Timestamp', sort: '@timestamp', dataFunction: (item) => { return this.$options.filters.timezoneDateString(item['@timestamp'], this.user.settings.timezone); }, help: 'Processed Timestamp', width: 220 }
      ]
    };
  },
  computed: {
