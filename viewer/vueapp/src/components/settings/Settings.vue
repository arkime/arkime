    ...
    <div
      ...
      <div class="col-xl-10 col-lg-9 col-md-9 col-sm-8 col-xs-12 settings-right-panel">
        ...
        <form
          ...
          <!-- TOTP Status/Actions -->
          <div class="form-group row">
            <label class="col-sm-3 col-form-label">{{ $t('settings.totp.status') }}</label>
            <div class="col-sm-9">
              <span
                v-if="totpEnabled"
          ...
          <div
            ...
            class="mt-3">
            <div class="form-group row">
              <label class="col-sm-3 col-form-label">{{ $t('settings.totp.scanQR') }}</label>
              <div class="col-sm-9">
                <div class="mb-2">
                  <img
                    v-if="totpQRDataUrl"
                  ...
                  <span
                    v-else
                    class="text-muted">{{ $t('settings.totp.generatingQR') }}</span>
                </div>
            ...
            <div class="form-group row">
              <label class="col-sm-3 col-form-label">{{ $t('settings.totp.verifyCode') }}</label>
              <div class="col-sm-9">
                <input
                  type="text"
                  maxlength="6"
          ...
          <div
            ...
            class="mt-3">
            <div class="form-group row">
              <label class="col-sm-3 col-form-label">{{ $t('settings.totp.confirmDisable') }}</label>
              <div class="col-sm-9">
                <input
                  type="text"
                  maxlength="6"
