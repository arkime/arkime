...
module.exports.buildInternals = (Config, http, https, EventEmitter) => {
  module.exports.internals = {
  ...
  module.exports.internals.scriptAggs['ip.dst:port'] = {
  ...
  if (module.exports.internals.prefix && !module.exports.internals.prefix.endsWith('_')) {
    module.exports.internals.prefix = `${module.exports.internals.prefix}_`;
  }

  if (Config.get('uploadFileSizeLimit')) {
    module.exports.internals.uploadLimits.fileSize = parseInt(Config.get('uploadFileSizeLimit'));
  }

  if (module.exports.internals.elasticBase[0].lastIndexOf('http', 0) !== 0) {
    module.exports.internals.elasticBase[0] = 'http://' + module.exports.internals.elasticBase[0];
  }
};
