...
a.oLanguage.sInfo.replace("_START_",b).replace("_END_",c).replace("_TOTAL_",f)+" "+a.oLanguage.sInfoFiltered.replace("_MAX_",a.fnFormatNumber(a.fnRecordsTotal()))+a.oLanguage.sInfoPostFix,a=a.aanFeatures.i;if("undefined"!=typeof a){e=0;for(b=a.length;e<b;e++)d(a[e]).html(f)}}}};g.oDefaults={trace:!1,rowHeight:"auto",serverWait:200};g.prototype.CLASS="Scroller";g.VERSION="1.0.2";g.prototype.VERSION=g.VERSION;"function"==typeof d.fn.dataTable&&"function"==typeof d.fn.dataTableExt.fnVersionCheck&&d.fn.dataTableExt.fnVersionCheck("1.8.0")?
