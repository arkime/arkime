...
$(document).ready(function() {
  if ($("#expression").length && $("#expression").autocomplete) {
    ...
    $("#expression").data('autocompleter').fetchRemoteData = function(filter,callback) {
      ...
      var commands = ["(", "ip", "ip.src", "ip.dst", "ip.dns", "ip.dns.count", "ip.xff", "ip.xff.cnt", "country", "country.src", "country.dst", "country.dns", "country.xff", "asn", "asn.src", "asn.dst", "asn.dns", "asn.xff", "bytes", "databytes", "protocol", "ua", "ua.cnt", "user", "user.cnt", "tags", "tags.cnt", "oldheader", "header", "header.src", "header.src.cnt", "header.dst", "header.dst.cnt", "node", "packets", "port", "port.src", "port.dst", "uri", "uri.cnt", "host", "host.cnt", "cert.issuer.cn", "cert.issuer.on", "cert.subject.cn", "cert.subject.on", "cert.serial", "cert.alt", "cert.alt.cnt", "cert.cnt", "ssh.key", "ssh.key.cnt", "ssh.ver", "ssh.ver.cnt", "email.src", "email.src.cnt", "email.dst", "email.dst.cnt", "email.subject", "email.subject.cnt", "email.ua", "email.ua.cnt", "email.fn", "email.fn.cnt", "email.mv", "email.mv.cnt", "email.ct", "email.ct.cnt", "email.id", "email.id.cnt"];
