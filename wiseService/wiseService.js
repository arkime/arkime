  ...
  configDefs: {
    wiseService: {
      ...
      fields: [
        ...
        { name: 'authmode', required: true, help: 'How should auth be done: anonymous - no auth, basic - basic auth, digest - digest auth, header - http header auth, oidc - oidc auth, form - form auth, saml - saml auth', regex: '(anonymous|basic|digest|header|oidc|form|saml)' },
