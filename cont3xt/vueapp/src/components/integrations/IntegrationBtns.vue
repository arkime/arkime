  ...
  <div class="wrap-btns">
    ...
    <template v-for="integration in buttonIntegrations">
      <b-button
        ...
        <b-badge
          class="btn-badge"
          v-if="shouldDisplayCountedButton(integration, integrationDataMap[integration.name])"
          :variant="integrationCountColor(integrationDataMap[integration.name])">
...
import {
  ...
  integrationCountColor, shouldDisplayCountedIntegrationBtn
...
export default {
      ...
      return sortedIntegrations.filter(integration => {
        ...
        if (this.countSeverityFilter) {
          return shouldDisplayCountedIntegrationBtn(integration, integrationData) &&
              this.countSeverityFilter === this.integrationCountColor(integrationData);
        }
  ...
  methods: {
    shouldDisplayCountedButton: shouldDisplayCountedIntegrationBtn,
    integrationCountColor,
