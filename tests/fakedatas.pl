...
################################################################################
my @WORDS = qw(
a abandon ability able abortion about above abroad absence absolute absolutely absorb abuse academic accept access 
...
between beyond Bible big bike bill billion bind biological bird birth birthday bit bite black blade blame blanket blind 
...
cholesterol choose Christian Christmas church cigarette circle circumstance cite citizen city civil civilian claim 
...
Italian item its itself jacket jail Japanese jet Jew Jewish job join joint joke journal journalist journey joy judge 
...
print "Creating $HTTP http recoreds\n";
for (my $i = 0; $i < $HTTP; $i++) {
    generateHTTP();
}
