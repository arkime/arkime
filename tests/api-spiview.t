...
# bigendian pcap file tests
    ...
    eq_or_diff($djson->{graph}, from_json('{"lpHisto": [[1335956400000, 1]], "dbHisto": [[1335956400000, 0]], "paHisto": [[1335956400000, 2]], "xmin": 1332734457000, "xmax": 1389743152000, "interval":3600}'), "date graph bigendian");
...
# Check facets ALL
    ...
    $djson = viewerGet("/spiview.json?startTime=1332734457&stopTime=1389743152&facets=1&spi=a1,a2,pr,fileand,ta:3,hh1&expression=" . uri_escape("file=$pwd/bigendian.pcap|file=$pwd/socks-http-example.pcap|file=$pwd/bt-tcp.pcap"));
    ...
    is($djson->{graph}->{xmax}, 1389743152000, "date graph ALL xmax");
