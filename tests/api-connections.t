...
# srcIp to dstIp
    ...
    eq_or_diff($json, from_json('{ "nodes": [
            ...
            {"id": "10.180.156.249", "totDataBytes": 33866, "network.bytes": 46190, "network.packets": 184, "cnt": 1, "sessions": 9, "type": 2, "pos": 4, "inresult": 1, "node": ["test"]} ], "links": [
            {"value": 2, "source": 0, "target": 1, "network.bytes": 29487, "totDataBytes": 25707, "network.packets": 66, "node": ["test"]},
            {"value": 1, "source": 1, "target": 0, "network.bytes": 1492, "totDataBytes": 327, "network.packets": 20, "node": ["test"]},
            {"value": 1, "source": 2, "target": 1, "network.bytes": 668, "totDataBytes": 85, "network.packets": 10, "node": ["test"]},
            {"value": 9, "source": 3, "target": 4, "network.bytes": 46190, "totDataBytes": 33866, "network.packets": 184, "node": ["test"]} ], "recordsFiltered": 13 }', {relaxed => 1}), "srcIp to dstIp", { context => 3 });
...
# srcIp to ip.dst
    ...
    eq_or_diff($json, from_json('{ "nodes": [
            ...
            {"id": "10.180.156.249:1080", "destination.port": [1080], "node": ["test"], "totDataBytes": 33866, "network.bytes": 46190, "network.packets": 184, "cnt": 1, "sessions": 9, "type": 2, "pos": 8, "inresult": 1} ], "links": [
            {"destination.port": [21477], "value": 1, "source": 0, "target": 3, "network.bytes": 2176, "totDataBytes": 1361, "network.packets": 14, "node": ["test"]},
            {"destination.port": [8855], "value": 1, "source": 0, "target": 5, "network.bytes": 27311, "totDataBytes": 24346, "network.packets": 52, "node": ["test"]},
            {"destination.port": [1080], "value": 1, "source": 2, "target": 1, "network.bytes": 1492, "totDataBytes": 327, "network.packets": 20, "node": ["test"]},
            {"destination.port": [42356], "value": 1, "source": 6, "target": 4, "network.bytes": 668, "totDataBytes": 85, "network.packets": 10, "node": ["test"]},
            {"destination.port": [1080], "value": 9, "source": 7, "target": 8, "network.bytes": 46190, "totDataBytes": 33866, "network.packets": 184, "node": ["test"]} ], "recordsFiltered": 13 }', {relaxed => 1}), "srcIp to ip.dst", { context => 3 });
...
# srcIp to cert.notAfter
    ...
    eq_or_diff($json, from_json('{ "nodes": [
            ...
            {"id": "1648944000000", "totDataBytes": 26760, "network.bytes": 32958, "network.packets": 93, "cnt": 1, "sessions": 3, "type": 2, "pos": 2, "inresult": 1, "node": ["test"]} ], "links": [
            {"value": 3, "source": 0, "target": 1, "network.bytes": 32958, "totDataBytes": 26760, "network.packets": 93, "node": ["test"]},
            {"value": 3, "source": 0, "target": 2, "network.bytes": 32958, "totDataBytes": 26760, "network.packets": 93, "node": ["test"]} ], "recordsFiltered": 3 }', {relaxed => 1}), "srcIp to cert.notAfter", { context => 3 });
...
# node to protocols with baseline
    ...
    eq_or_diff($json, from_json('{ "nodes": [
            ...
            {"totDataBytes": 2008, "type": 2, "sessions": 12, "network.packets": 19, "node": ["test"], "network.bytes": 2814, "id": "udp", "inresult": 3, "pos": 21, "cnt": 1} ], "recordsFiltered": 63, "links": [
            ...
            {"target": 6, "source": 18, "network.packets": 4, "network.bytes": 256, "node": ["test"], "value": 1, "totDataBytes": 18},
            ...
            {"target": 13, "network.packets": 404, "node": ["test"], "network.bytes": 56558, "source": 18, "totDataBytes": 30577, "value": 16},
            ...
            {"source": 18, "node": ["test"], "network.bytes": 2814, "network.packets": 19, "value": 12, "totDataBytes": 2008, "target": 21} ] }', {relaxed => 1}), "node to protocol baselined", { context => 3 });
