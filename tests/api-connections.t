...
# node to protocols with baseline
    ...
    eq_or_diff($json, from_json('{"nodes":[
            ...
            {"inresult":1,"pos":1,"cnt":1,"id":"corrupt","node":["test"],"network.bytes":903,"network.packets":2,"totDataBytes":0,"type":2,"sessions":2},
            {"totDataBytes":1878,"sessions":10,"type":2,"network.packets":35,"node":["test"],"network.bytes":3876,"id":"dns","pos":2,"inresult":3,"cnt":1},
            {"totDataBytes":320,"sessions":3,"type":2,"network.packets":6,"node":["test"],"network.bytes":1559,"id":"gre","inresult":1,"pos":3,"cnt":1},
            ...
            {"totDataBytes":375065,"sessions":145,"type":1,"node":["test"],"network.bytes":531068,"network.packets":2420,"id":"test","pos":18,"inresult":3,"cnt":21},
            ...
            {"totDataBytes":2008,"type":2,"sessions":12,"network.packets":19,"node":["test"],"network.bytes":2814,"id":"udp","inresult":3,"pos":21,"cnt":1}],"recordsFiltered":64,"links":[{"target":13,"network.packets":404,"node":["test"],"network.bytes":56558,"source":18,"totDataBytes":30577,"value":16},
            ...
            {"target":1,"source":18,"node":["test"],"network.bytes":903,"network.packets":2,"value":2,"totDataBytes":0},
            {"target":3,"source":18,"network.packets":6,"network.bytes":1559,"node":["test"],"value":3,"totDataBytes":320},
