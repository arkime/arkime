...
# new /detail api
    ...
    $sd = $MolochTest::userAgent->get("http://$MolochTest::host:8125/api/sessions/$id/test/detail")->content;
...
# http
    ...
    $sd = $MolochTest::userAgent->get("http://$MolochTest::host:8123/api/sessions/$id/test/packets?line=true&ts=false&base=hex")->content;
...
# http gzip:true
    ...
    $sd = $MolochTest::userAgent->get("http://$MolochTest::host:8123/api/sessions/$id/test/packets?line=true&ts=false&base=hex&gzip=true")->content;
...
# http image:true
    ...
    ok($sd =~ m{col:.80:quic.*api/sessions/\Q$id\E/test/body/file/1/crossdomain.xml.pellet}s, "encoding:natural image:true");
    ...
    ok($sd =~ m{col:.80:quic.*api/sessions/\Q$id\E/test/body/file/1/crossdomain.xml.pellet}s, "encoding:ascii image:true");
    ...
    ok($sd =~ m{636f 6c3a 2038 303a 7175 6963 0d0a 0d0a.*col:.80:quic.*api/sessions/\Q$id\E/test/body/file/1/crossdomain.xml.pellet}s, "encoding:hex image:true");
    ...
    ok($sd =~ m{00000272:.*636f 6c3a 2038 303a 7175 6963 0d0a 0d0a.*col:.80:quic.*api/sessions/\Q$id\E/test/body/file/1/crossdomain.xml.pellet}s, "encoding:hex line:true image:true");
...
# smtp
    ...
    $sd = $MolochTest::userAgent->get("http://$MolochTest::host:8123/test/session/$id/packets?line=false&ts=false&base=natural&image=true")->content;
    ok($sd =~ m{href="api/sessions/\Q$id\E/test/body/file/1/a.zip.pellet">a.zip<\/a>}s, "smtp encoding:natural image:true");
