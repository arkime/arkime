...
# http image:true
    ...
    ok($sd =~ m{col:.80:quic.*api/session/test/\Q$id\E/body/file/1/crossdomain.xml.pellet}s, "encoding:natural image:true");
    ...
    ok($sd =~ m{col:.80:quic.*api/session/test/\Q$id\E/body/file/1/crossdomain.xml.pellet}s, "encoding:ascii image:true");
    ...
    ok($sd =~ m{636f 6c3a 2038 303a 7175 6963 0d0a 0d0a.*col:.80:quic.*api/session/test/\Q$id\E/body/file/1/crossdomain.xml.pellet}s, "encoding:hex image:true");
    ...
    ok($sd =~ m{00000272:.*636f 6c3a 2038 303a 7175 6963 0d0a 0d0a.*col:.80:quic.*api/session/test/\Q$id\E/body/file/1/crossdomain.xml.pellet}s, "encoding:hex line:true image:true");
