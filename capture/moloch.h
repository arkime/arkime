...
#define MOLOCH_FIELD_EXSPECIAL_TCPFLAGS_PSH  (MOLOCH_FIELDS_CNT_MAX+5)
#define MOLOCH_FIELD_EXSPECIAL_TCPFLAGS_RST  (MOLOCH_FIELDS_CNT_MAX+6)
#define MOLOCH_FIELD_EXSPECIAL_TCPFLAGS_ACK  (MOLOCH_FIELDS_CNT_MAX+7)
#define MOLOCH_FIELD_EXSPECIAL_PACKETS_SRC   (MOLOCH_FIELDS_CNT_MAX+8)
#define MOLOCH_FIELD_EXSPECIAL_PACKETS_DST   (MOLOCH_FIELDS_CNT_MAX+9)
#define MOLOCH_FIELD_EXSPECIAL_DATABYTES_SRC (MOLOCH_FIELDS_CNT_MAX+10)
#define MOLOCH_FIELD_EXSPECIAL_DATABYTES_DST (MOLOCH_FIELDS_CNT_MAX+11)
#define MOLOCH_FIELDS_MAX                    (MOLOCH_FIELDS_CNT_MAX+12)
